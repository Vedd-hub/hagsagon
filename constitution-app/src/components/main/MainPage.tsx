...
const MainPage: React.FC = () => {
  ...
  const userName = userData?.displayName || (currentUser.email?.split('@')[0] || 'User');
            ...
            <ul className="space-y-2 p-2">
              ...
              <li>
                <button 
                  ...
                  className={`w-full flex items-center p-3 rounded-lg transition-colors ${activeSection === 'explore' ? 'bg-[#f5e1a0]/20' : 'hover:bg-white/10'}`}
                >
                  <ExploreIcon />
                  <span className="ml-3 hidden lg:inline">Explore</span>
                </button>
              </li>
              <li>
                <button 
